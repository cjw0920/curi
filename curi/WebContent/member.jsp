...
/* 	 
		...
		if(idVal == ""){
			...
			$.ajax({
				...
				success:function(data){
					if(data.message=="-1"){
						$("#fil_id").text("사용할수 없습니다.").css("display","block").css("color","red");
					}else{
						$("#fil_id").text("사용할수 있습니다.").css("display","block").css("color","#00c73c");
					}
				},
				error:function(){
					alert("system error..");
	...
	$("#input_phone").blur(function() {
		...
		if(pVal == ""){
			...
			$("#fil_phone").css("display","none");
	 	    $(this).parent().css("margin_bottom","16px");
		}
	});
/* 
	$("#input_ad1").focus(function(){
        $(this).css("font-size","17px");
        $("#insert_label6").css("bottom","25px").css("font-size","10px");
    });
    
	$("#input_ad1").blur(function() {
	    
	    var idVal = $(this).val();
		if(idVal == ""){
		         $(this).css("font-size", "5px");
		         $("#insert_label6").css("bottom","10px").css("font-size","14px");
		         $("#fil_id").css("display","block");
		 	    $(this).parent().css("margin_bottom","30px");
		}else{
			$("#fil_id").css("display","none");
	 	    $(this).parent().css("margin_bottom","16px");
		}
    });
	
	$("#input_ad2").focus(function(){
        $(this).css("font-size","17px");
        $("#insert_label7").css("bottom","25px").css("font-size","10px");
    });
    
	$("#input_ad2").blur(function() {
	    
	    var idVal = $(this).val();
		if(idVal == ""){
		         $(this).css("font-size", "5px");
		         $("#insert_label7").css("bottom","10px").css("font-size","14px");
		         $("#fil_id").css("display","block");
		 	    $(this).parent().css("margin_bottom","30px");
		}else{
			$("#fil_id").css("display","none");
	...
	$("#input_ad3").focus(function(){
        $(this).css("font-size","17px");
        $("#insert_label8").css("bottom","25px").css("font-size","10px");
    });
    
	$("#input_ad3").blur(function() {
	    
	    var idVal = $(this).val();
		if(idVal == ""){
		         $(this).css("font-size", "5px");
		         $("#insert_label8").css("bottom","10px").css("font-size","14px");
		         $("#fil_id").css("display","block");
		 	    $(this).parent().css("margin_bottom","30px");
		}else{
			$("#fil_id").css("display","none");
		...
		<div id="memtle">
			...
			<div id="divcon">
				...
				<div id="right">
						...
						<table>
							...
							<td>
								<div id="insert_name">
									...
									<input type="text" id="input_name" class="input_join" id="nameval" name="input_name">
								</div>
							</td>
							</tr>
							<tr>
							<td class="space">아이디 <br><span id ="fil_id" class="filso"> *</span></td>

							<td>
								<div id="insert_id">
									<label for="input_id" id="insert_label2"> 아이디 </label> 
									<input type="text" id="input_id" class="input_join" id="idval" name="input_id">
							...
							<tr>
								...
								<td>
									<div id="insert_pw">
										...
										<input type="password" id="input_pw" class="input_join checkpw" id="pwval" name="input_pw">
							...
							<tr>
								...
								<td>
									<div id="insert_phone">
										...
										<input type="text" id="input_phone" class="input_join" id="phoneval" name="input_phone">
							...
							<tr>
								...
								<td>
									<div id="insert_ad">
										<input type="text" id="sample6_postcode" placeholder="우편번호" class="input_join addrbtn" readonly="readonly" name="adr1val"> 
										
										<input type="button" onclick="sample6_execDaumPostcode()"  value="우편번호 찾기" id="search"><br>
										
										<input type="text" id="sample6_address" placeholder="주소" class="input_join addrbtn" readonly="readonly" name="adr2val"> 
										
										<input type="text" id="sample6_address2" placeholder="상세주소" class="input_join" name="adr3val">
					...
					<div id="end"> 
							<span><a href="#" id="fini">가입완료</a></span>
					</div>
